...
;General
  ...
  ;Name and file
  Name "Chami"
  OutFile "ChamiInstaller.exe"

  ;Default installation folder
  InstallDir "$LOCALAPPDATA\Chami"
  
  ;Get installation folder from registry if available
  InstallDirRegKey HKCU "Software\Chami" ""
...
;Language Selection Dialog Settings
  ...
  !define MUI_LANGDLL_REGISTRY_KEY "Software\Chami" 
